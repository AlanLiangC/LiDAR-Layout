...
class NuScenesCubeDecodeDataset(DefaultDataset):
    def __init__(self, load_semantic=False, sweeps=10, ignore_index=-1, **kwargs):
    ...
    def get_data(self, idx):
        ...
        if "gt_segment_path" in data.keys() and self.load_semantic:
